                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                    ...
                    <table class="table-fixed w-full">
                        ...
                        <tr v-for="row in data">
                            ...
                            <td class="border px-4 py-2">{{ row.is_done ? 'Yes' : 'No' }}</td>
                                ...
                                <form>
                                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        <div class="">
                                            ...
                                            <div class="mb-4">
                                                <label for="exampleFormControlInput3" class="block text-gray-700 text-sm font-bold mb-2">Is Done:</label>
                                                <input type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="exampleFormControlInput3" v-model="form.is_done">
                                                <div v-if="$page.props.errors.is_done" class="text-red-500">{{ $page.props.errors.is_done }}</div>
                                            </div>
                                        </div>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        deleteRow: function (data) {
            if (!confirm('Are you sure want to remove this todo?')) return;
            data._method = 'DELETE';
            this.$inertia.post('/todos/' + data.id, data)
            this.reset();
            this.closeModal();
